...
```bash
git clone https://github.com/jho7u7/weather-app.git
cd weather-app
```
...
Proyecto desarrollado como parte de una **prueba técnica Front End**.
